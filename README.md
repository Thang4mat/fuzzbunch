...
# How to install
- download the package from https://gitlab.com/peterpt/fuzzbunch/-/archive/master/fuzzbunch-master.zip
- extract it to your hard disk

** Windows OS:
- run install.bat to install FuzzBunch.
- Run FuzzBunch Console.ink
- When running fuzzbunch java link , make sure you write on the logs path (C:\fuzzbunch\windows\Logs\PROJECT_NAME)
...
- Step 2: Install FuzzBunch:
```
cd /root/.wine/drive_c/fuzzbunch/
wineconsole install.bat
```

- Step 4: Add python and fuzzbunch to PATH:
```
wine regedit.exe
...
Type: String
Name: PATH
Value: c:\\windows;c:\\windows\\system;C:\\Python26;C:\\fuzzbunch\\windows\\fuzzbunch
```
